<%@ Page Language="C#" MasterPageFile="~/NestedMasterPage.master" AutoEventWireup="true" CodeBehind="tuiguang.aspx.cs" Inherits="GameAdminWeb.GameUser.tuiguang" %>
                            ...
                            <table class="table table-hover table-bordered page-header table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>昵称</th>
                                        <th>密码</th>
                                        <th><a href="javascript:;" onclick='sorting("UserRight")'>充值</a></th>
            ...
            <div class="modal-dialog" role="document" id="modal">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>充值</label>
                            <input type="text" name="txt_UserRight" class="form-control" id="txt_UserRight" runat="server" placeholder="充值" />
                        </div>
                        <div class="form-group">
                            <label>金币</label>
...
<asp:Content ID="Tail" ContentPlaceHolderID="Tail" runat="Server">
    <script type="text/javascript">
        ...
        function sorting(type) {
            window.location.href = "tuiguang.aspx?page=GameUser&type=tuiguang&typeName=" + type + "&Sorting=" + $("#ContentPlaceHolder1_txt_Sorting").val() + "";
        }
    </script>   
</asp:Content>