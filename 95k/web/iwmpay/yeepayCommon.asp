...
Sub getCallBackValue(ByRef r0_Cmd,ByRef r1_Code,ByRef r2_TrxId,ByRef r3_Amt,ByRef r4_Cur,ByRef r5_Pid,ByRef r6_Order,ByRef r7_Uid,ByRef r8_MP,ByRef r9_BType,ByRef hmac)
	r0_Cmd		=	YeSqlStr(Request("r0_Cmd"),3)
	r1_Code		=	YeSqlStr(Request("r1_Code"),3)
	r2_TrxId	=	YeSqlStr(Request("r2_TrxId"),3)
	r3_Amt		=	YeSqlStr(Request("r3_Amt"),3)
	r4_Cur		=	YeSqlStr(Request("r4_Cur"),3)
	r5_Pid		=	YeSqlStr(Request("r5_Pid"),3)
	r6_Order	=	YeSqlStr(Request("r6_Order"),3)
	r7_Uid		=	YeSqlStr(Request("r7_Uid"),3)
	r8_MP			=	YeSqlStr(Request("r8_MP"),3)
	r9_BType	=	YeSqlStr(Request("r9_BType"),3)
	hmac			=	YeSqlStr(Request("hmac"),3)
End Sub
